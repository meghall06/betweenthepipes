...
```{r mutate, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  filter() %>%
  select() %>%
...
```{r mutate-2, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  filter(event_team == "PHI") %>%
  select(game_id, event_player_1, event_type) %>%
  mutate(shot_on_goal = ifelse(event_type == "SHOT" | event_type == "GOAL", 1, 0),
...
```{r mutate-3, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  filter(event_team == "PHI") %>%
  select(game_id, event_player_1, event_type) %>%
  mutate(shot_on_goal = ifelse(event_type == "SHOT" | event_type == "GOAL", 1, 0),
...
```{r mutate-4, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  filter(event_team == "PHI") %>%
  select(game_id, event_player_1, event_type) %>%
  mutate(shot_on_goal = ifelse(event_type == "SHOT" | event_type == "GOAL", 1, 0),
...
```{r regulation-1, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  group_by() %>%
...
```{r regulation, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  group_by(game_id) %>%
  summarize(max_period = max(game_period)) %>%
...
```{r shperc, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  filter() %>%
  mutate(shot_on_goal = ,
          goal = ) %>%
...
```{r standings, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  group_by() %>%
...
```{r faceoff, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  filter() %>%
...
```{r corsi, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  filter() %>%
  count()
```
...
```{r penalty, eval = FALSE, exercise = TRUE, exercise.eval = FALSE}
hockey_data %>%
  filter() %>%
  count()
```
